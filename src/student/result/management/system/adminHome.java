...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student/result/management/system/ad.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(UserName.equals("admin") && Password.equals("pass")){     //check user name and pass is correct or not 
            setVisible(false);                                               //if not correct user name and password 
            new index().setVisible(true);
        }
        else{
          JOptionPane.showMessageDialog(rootPane,"Incorrect password and UserName");
        }
